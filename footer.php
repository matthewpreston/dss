		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-4 col-sm-offset-1 blog-links">
					<a href="https://www.facebook.com/UofTDSS/" title="DSS - Facebook"><img class="blog-icon" src="<?php echo get_bloginfo('template_directory');?>/img/facebook logo.svg"></a>
					<a href="https://www.flickr.com/photos/154578217@N08/albums" title="DSS - Flickr"><img class="blog-icon" src="<?php echo get_bloginfo('template_directory');?>/img/flickr logo.svg"></a>
